...
namespace SG_SST.Revision.Servicios.Controllers
{
    public class RevisionServicioController : ApiController
    {
        ...
        public HttpResponseMessage EliminarParticipanteRevision(EDParticipanteRevision participante)
        {
            try
            {
                var logica = new LNRevision();
                var result = logica.EliminarParticipanteRevision(participante);
                if (result != null)
                {
                    var response = Request.CreateResponse(HttpStatusCode.OK, result);
                    return response;
        ...
        public HttpResponseMessage EliminarTemaAgendaRevision(EDAgendaRevision agenda)
        {
            try
            {
                var logica = new LNRevision();
                var result = logica.EliminarTemaAgendaRevision(agenda);
                if (result != null)
                {
                    var response = Request.CreateResponse(HttpStatusCode.OK, result);
                    return response;
        ...
        public HttpResponseMessage EliminarActaRevision(EDActaRevision acta)
        {
            try
            {
                var logica = new LNRevision();
                var result = logica.EliminarActaRevision(acta);
                if (result != null)
                {
                    var response = Request.CreateResponse(HttpStatusCode.OK, result);
                    return response;
        ...
        public HttpResponseMessage EliminarAdjuntoTemaAgendaRevision(EDAdjuntoAgendaRevision adjunto)
        {
            try
            {
                var logica = new LNRevision();
                var result = logica.EliminarAdjuntoTemaAgendaRevision(adjunto);
                if (result != null)
                {
                    var response = Request.CreateResponse(HttpStatusCode.OK, result);
                    return response;
