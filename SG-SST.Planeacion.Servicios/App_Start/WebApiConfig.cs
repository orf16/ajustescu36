    ...
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
           ...
           routeTemplate: "sg-sst/EstudioPuestoTrabajo/{action}/{id}",///es la Url, que se tiene en el Webconfig de la capa presentacion.
            ...
            config.Routes.MapHttpRoute(
    name: "MetasIndicadores",
    routeTemplate: "sg-sst/MetasIndicadores/{action}/{id}",
    defaults: new
    {
        controller = "MetasIndicadores",
        id = RouteParameter.Optional
    }
);

            config.Routes.MapHttpRoute(
name: "PlanEmergencias",
routeTemplate: "sg-sst/PlanEmergencias/{action}/{id}",
defaults: new
{
    controller = "PlanEmergencias",
    id = RouteParameter.Optional
}
);
