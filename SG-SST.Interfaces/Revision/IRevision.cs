...
namespace SG_SST.Interfaces.Revision
{
    public interface IRevision
    {
        ...
        List<EDParticipanteRevision> EliminarParticipanteRevision(EDParticipanteRevision participante);
        ...
        List<EDAgendaRevision> EliminarTemaAgendaRevision(EDAgendaRevision agenda);

        List<EDActaRevision> EliminarActaRevision(EDActaRevision acta);
        ...
        List<EDAdjuntoAgendaRevision> EliminarAdjuntoTemaAgendaRevision(EDAdjuntoAgendaRevision adjunto);
