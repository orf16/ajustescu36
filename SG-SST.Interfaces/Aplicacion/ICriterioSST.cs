...
namespace SG_SST.Interfaces.Aplicacion
{
    ...
    public interface ICriterioSST
    {
        ...
        bool EliminarCalificacionProveedor(int idProveePorCalif, EDInformacionAuditoria edInfoauditoria);
        ...
        /// <returns>retorna verdadero si fue posible eliminarlo en la base de datos o false de lo contrario</returns>
        bool EliminarProductoCriterio(int idProducto, EDInformacionAuditoria edInfoauditoria);
