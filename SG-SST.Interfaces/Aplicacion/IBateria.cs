...
namespace SG_SST.Interfaces.Aplicacion
{
    public interface IBateria
    {
        ...
        EDBateriaGestion ConsultarGestionResultadoGeneral(int IdGestion, int IdEmpresa);
        ...
        EDBateriaInicial ConsultarInicialSoloIntra(int PkIdUsuario, int FkEmpresa);
        void VerificarEncuestas(int IdGestion, int FkEmpresa);
        void VerificarEncuestasAdministrador();
    }
}
