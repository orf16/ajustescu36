...
namespace SG_SST.Interfaces.Participacion
{
    public interface IReporte
    {
        ...
        List<EDGrupo> ObtenerGruposPorComunicacion(string nit);


        List<EDCargo> ObtenerCargosPorComunicacion(string nit);

        List<EDCargo> ObtenerCargosAPPPorComunicacion(string nit);

        bool ValidarExistePlanAccionCondicionesInseguras(int idActa);
        bool EliminarReporteCondicionesInseguras(int idActa);
