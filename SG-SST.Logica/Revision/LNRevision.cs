...
namespace SG_SST.Logica.Revision
{
    public class LNRevision
    {
        ...
        {
            return em.EliminarParticipanteRevision(participante);
        }
        ...
        {
            return em.EliminarTemaAgendaRevision(agenda);
        }

        public List<EDActaRevision> EliminarActaRevision(EDActaRevision acta)
        {
            return em.EliminarActaRevision(acta);
        }
        ...
        {
            return em.EliminarAdjuntoTemaAgendaRevision(adjunto);
        }
