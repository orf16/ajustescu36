...
namespace SG_SST.Logica.Aplicacion
{
    public class LNBateria
    {
        ...
        {
            EDBateriaGestion EDBateriaGestion = bat.ConsultarGestionResultadoGeneral(IdGestion, IdEmpresa);
            return EDBateriaGestion;
        }
        ...
        {
            EDBateriaInicial EDBateriaInicial = bat.ConsultarInicialSoloIntra(PkIdUsuario, FkEmpresa);
            return EDBateriaInicial;
        }
        public void VerificarEncuestas(int IdGestion, int FkEmpresa)
        {
            bat.VerificarEncuestas(IdGestion, FkEmpresa);
        }
        public void VerificarEncuestasAdministrador()
        {
            bat.VerificarEncuestasAdministrador();
        }
    }
}
