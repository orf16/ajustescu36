...
namespace SG_SST.Logica.Participacion
{
    public class LNReporte
    {
        ...
        {
            return Reportes.ObtenerGruposPorComunicacion(nit);
        }

        public List<EDCargo> ObtenerCargosPorComunicacion(string nit)
        {
            return Reportes.ObtenerCargosPorComunicacion(nit);
        }

        public List<EDCargo> ObtenerCargosAPPPorComunicacion(string nit)
        {
            return Reportes.ObtenerCargosAPPPorComunicacion(nit);
        }

        public bool ValidarExistePlanAccionCondicionesInseguras(int idReporte)
        {
            return Reportes.ValidarExistePlanAccionCondicionesInseguras(idReporte);
        }

        public bool EliminarReporteCondicionesInseguras(int idReporte)
        {
            return Reportes.EliminarReporteCondicionesInseguras(idReporte);
        }
