...
namespace SG_SST.Models.Planificacion
{
    ...
    public class RAM 
    {
        ...
        /// </summary>
        public virtual ICollection<EstimacionDeRiesgoPorRAM> EstimacionDeRiesgosPorRAM { get; set; }

        public string ToString()
        {
            string cadena = "PK_RAM: " + PK_RAM +
                            " Consecuencias_Reales: " + Consecuencias_Reales +
                            " Consecuencias_Potenciales: " + Consecuencias_Potenciales +
                            " Nivel_De_Riesgo: " + Nivel_De_Riesgo;
            foreach (EstimacionDeRiesgoPorRAM edrr in EstimacionDeRiesgosPorRAM)
                cadena = cadena + " EstimacionDeRiesgoPorRAM:{ " + edrr.ToString() + "}";
            return cadena;
        }
    }
}