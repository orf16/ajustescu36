...
namespace SG_SST.Models.Planificacion
{
    ...
    public class ProbabilidadPorPersonaExpuesta
    {
        ...
        {
            string cadena = "PK_Probabilidad_Por_PersonaExpuesta: " + PK_Probabilidad_Por_PersonaExpuesta +
                            " Probabilidad: " + ((Probabilidad == null) ? FK_Probabilidad.ToString() : Probabilidad.Descripcion_Probabilidad);
            return cadena;
        }
