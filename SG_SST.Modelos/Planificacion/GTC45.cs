...
namespace SG_SST.Models.Planificacion
{
    ...
    public class GTC45
    {
        ...
        {
            string cadena = "PK_GTC45: " + PK_GTC45 +
                            " FLG_Higienico: " + FLG_Higienico +
                            " FLG_Tipo_De_Calificacion: " + FLG_Tipo_De_Calificacion +
                            " Efectos_Posibles: " + Efectos_Posibles +
                            " Nivel_De_Probablidad: " + Nivel_De_Probablidad +
                            " Nivel_De_Riesgo: " + Nivel_De_Riesgo +
                            " Numero_De_Expuestos: " + Numero_De_Expuestos +
                            " Peor_Consecuencia: " + Peor_Consecuencia +
                            " FLG_Requisito_Legal: " + FLG_Requisito_Legal +
                            " NivelDeDeficiencia: " + ((NivelDeDeficiencia == null) ? FK_Nivel_De_Deficiencia.ToString() : NivelDeDeficiencia.Descripcion_Deficiciencia) +
                            " NivelDeExposicion: " + ((NivelDeExposicion == null) ? FK_Nivel_De_Exposicion.ToString() : NivelDeExposicion.Descripcion_Exposicion); 
            return cadena;
        }
