...
namespace SG_SST.Models.Planificacion
{
    ...
    public class ConsecuenciaPorPeligro
    {
        ...
        {
            string cadena = "PK_Consecuencia_Por_Peligro: " + PK_Consecuencia_Por_Peligro +
                            " Consecuencia: " + ((Consecuencia == null) ? FK_Consecuencia.ToString() : Consecuencia.Descripcion_Consecuencia);
            return cadena;
        }
    }
}