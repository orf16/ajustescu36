...
namespace SG_SST.Models.Planificacion
{
    ...
    public class ClasificacionPeligroDx
    {
        ...
        {
            string cadena = " idClasificacionPeligroDx: " + idClasificacionPeligroDx +
                            " ClasificacionesDePeligro: " + ((ClasificacionDePeligro == null) ? FK_Clasificacion_De_Peligro.ToString() : ClasificacionDePeligro.Descripcion_Clase_De_Peligro);                          
           return cadena;
        }
    }
}
