...
namespace SG_SST.Models.Planificacion
{
    ...
    public class EstimacionDeRiesgoPorRAM
    {
        ...
        {
            string cadena = "PK_Estimacion_Riesgo_Por_RAM: " + PK_Estimacion_Riesgo_Por_RAM +
                            " EstimacionDeRiesgo: " + ((EstimacionDeRiesgo == null) ? FK_Estimacion_De_Riesgo.ToString() : EstimacionDeRiesgo.Detalle_Estimacion);
            return cadena;
