...
namespace SG_SST.Models.Planificacion
{
    ...
    public class DiagnosticoCie10Dx
    {
        ...
        {
            string cadena = " idDiagnosticoCie10Dx: " + idDiagnosticoCie10Dx +
                            " Trabajadores_Con_Diagnostico: " + Trabajadores_Con_Diagnostico +
                            " Diagnostico: " + ((Diagnostico == null) ? FK_Diagnostico.ToString() : Diagnostico.Descripcion);                            
            return cadena;
        }
    }
}
