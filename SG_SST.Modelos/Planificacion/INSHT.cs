...
namespace SG_SST.Models.Planificacion
{
    ...
    public class INSHT
    {
        ...
        {
            string cadena = "PK_INSHT: " + PK_INSHT +
                            " Estimacion_Riesgo: " + Estimacion_Riesgo +
                            " Medidas_De_Control: " + Medidas_De_Control +
                            " Procedimientos_De_Trabajo: " + Procedimientos_De_Trabajo +
                            " Informacion: " + Informacion +
                            " Formacion: " + Formacion +
                            " Riesgo_Controlado: " + Riesgo_Controlado +
                            " Accion_Requerida: " + Accion_Requerida +
                            " Responsable: " + Responsable +
                            " Fecha_Finalizacion: " + Fecha_Finalizacion +
                            " Fecha_De_Comprobacion: " + Fecha_De_Comprobacion +
