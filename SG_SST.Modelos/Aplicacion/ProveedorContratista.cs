...
namespace SG_SST.Models.Aplicacion
{
    ...
    public class ProveedorContratista
    {
        ...
        {
            string cadena = " PK_ProveedorContratista: " + PK_ProveedorContratista +
                            " Nombre_ProveedorContratista: " + Nombre_ProveedorContratista +
                            " IdEmpresa: " + IdEmpresa +
                            " FrecuenciaEval: " + FrecuenciaEval +
                            " CalificacionHist: " + CalificacionHist +
