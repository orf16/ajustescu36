...
namespace SG_SST.Models.Aplicacion
{
    ...
    public class ProveedorPorProducto
    {
        ...
        {
            string cadena = " Id_Pk_ProveedorPorProducto: " + Id_Pk_ProveedorPorProducto +
                            " Empresa: " + ((ProveedorContratista == null) ? Fk_Id_ProveedorContratista.ToString() : ProveedorContratista.ToString()) +
