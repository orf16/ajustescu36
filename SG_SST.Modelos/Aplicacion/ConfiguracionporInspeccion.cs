...
using System.ComponentModel.DataAnnotations.Schema;
    ...
    public class ConfiguracionporInspeccion
    {
       ...
       public virtual ConfiguracionInspeccion ConfiguracionInspeccion { get; set; }
        ...
        {
            string cadena = " Pk_Id_ConfiguracionPorInspeccion: " + Pk_Id_ConfiguracionPorInspeccion +
                            " Fk_Id_ConfiguracionInspeccion: " + Fk_Id_ConfiguracionInspeccion +
                            " Fk_Id_Inspecciones: " + Fk_Id_Inspecciones;                                 
            return cadena;
        }
