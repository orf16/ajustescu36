...
namespace SG_SST.Models.Aplicacion
{
...

    {
        ...
        {
            string cadena = " Pk_Id_ConfiguracionInspeccion: " + Pk_Id_ConfiguracionInspeccion +
                            " DescripcionPrioridadConf: " + DescripcionPrioridadConf +
                            " DiasDesdeConfig: " + DiasDesdeConfig +
                            " DiasHastaConfig: " + DiasHastaConfig;
            return cadena;
        }
    }
}
