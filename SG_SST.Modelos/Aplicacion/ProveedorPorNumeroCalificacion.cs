...
namespace SG_SST.Models.Aplicacion
{
    ...
    public class ProveedorPorNumeroCalificacion
    {
        ...
        {
            string cadena = " PK_ProveedorPorNumeroCalificacion: " + PK_ProveedorPorNumeroCalificacion +
                            " ProveedorContratista: " + ((ProveedorContratista == null) ? Fk_Id_ProveedorContratista.ToString() : ProveedorContratista.ToString()) +
                            " CalificacionProveedor: " + ((CalificacionProveedor == null) ? Fk_Id_CalificacionProveedor.ToString() : CalificacionProveedor.ToString());
            return cadena;
        }
    }
}
