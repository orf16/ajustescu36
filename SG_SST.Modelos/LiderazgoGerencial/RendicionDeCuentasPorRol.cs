namespace SG_SST.Models.LiderazgoGerencial
{
    ...
    public class RendicionDeCuentasPorRol
    {
        ...
        {
            string cadena = " Id_Pk_RendicionDeCuentasPorRol: " + Id_Pk_RendicionDeCuentasPorRol +
                            " RendicionDeCuenta: " + ((RendicionDeCuentas == null) ? Fk_Id_RendicionDeCuentas.ToString() : RendicionDeCuentas.Descripcion);
            return cadena;
        }
    }
}
