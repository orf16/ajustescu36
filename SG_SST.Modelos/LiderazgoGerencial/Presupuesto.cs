...
namespace SG_SST.Models
{
    ...
    public class Presupuesto
    {
        ...
        {
            string cadena = "PK_Prepuesto: " + PK_Prepuesto +
                            " RubroTotal: " + RubroTotal;
                foreach (PresupuestoPorAnio presupuestoPorAnio in presupuestosPorAnio)
                cadena = cadena + " PresupuestoPorAnio:{ " + presupuestoPorAnio.ToString() + "}";            
            return cadena;
        }
