...
namespace SG_SST.Models.LiderazgoGerencial
{
    ...
    public class PresupuestoPorMes
    {
        ...
        {
            string cadena = "PK_Prepuesto_Por_Mes: " + PK_Prepuesto_Por_Mes +
                            " PresupuestoMes: " + PresupuestoMes +
                            " PresupuestoEjecutadoPorMes: " + FK_Actividad_Presupuesto +
                            " Mes: " + Mes +
                            " ComentarioPresupuestoMesEjecutado: " + ComentarioPresupuestoMesEjecutado +
                            " FK_Presupuesto: " + FK_Presupuesto +
                            "FK_Actividad_Presupuesto" + FK_Actividad_Presupuesto;            
            return cadena;
        }
    }
}
