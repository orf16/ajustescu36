...
namespace SG_SST.Models.LiderazgoGerencial
{
    ...
    public class ResponsabilidadesPorRol
    {
        ...
        {
            string cadena = " Id_Pk_ResponsabilidadesPorRol: " + Id_Pk_ResponsabilidadesPorRol +
                            " Responsabilidad: " + ((Responsabilidades == null) ? Fk_Id_Responsabilidades.ToString() : Responsabilidades.Descripcion);            
            return cadena;
        }
    }
}
