...
namespace SG_SST.Models.LiderazgoGerencial
{
    ...
    public class ActividadPresupuesto
    {
        ...
        {
            string cadena = "PK_Actividad_Presupuesto: " + PK_Actividad_Presupuesto +
                            " DescripcionActividad: " + DescripcionActividad +
                            " FK_Actividad_Presupuesto: " + FK_Actividad_Presupuesto;
            if (presupuestosPorMes != null)
                foreach (PresupuestoPorMes presupuestoPorMes in presupuestosPorMes)
                    cadena = cadena + " presupuestoPorMes:{ " + presupuestoPorMes.ToString() + "}";
            return cadena;
        }
    }
}
