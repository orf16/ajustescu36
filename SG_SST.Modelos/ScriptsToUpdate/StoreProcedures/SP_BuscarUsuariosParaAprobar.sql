...
BEGIN
	...
	begin
		select	ua.Pk_id_UsuarioParaAprobar as IdUsuarioPorAprobar, ua.Nombres, ua.Apellidos, ua.EmailUsuario as Correo, tde.Descripcion as TipoDocumentoEmpresa,
				...
				RutaPdfAutorizacion =
				case 
					when dau.ValorDato is null then 'No Aplica'
				else
					dau.ValorDato
				end
		from Tbl_UsuariosParaAprobar ua
		left join Tbl_DatosAdicionalesUsuario dau on ua.Pk_id_UsuarioParaAprobar = dau.CodUsuarioAprobar and dau.NombreDato = 'RutaPdfAutorizacion'
