...
namespace SG_SST.Models.Empresas
{
    ...
    public class Rol
    {
        ...
        {
            string cadena = " Pk_Id_Rol: " + Pk_Id_Rol +
                            " Descripcion: " + Descripcion;
            foreach (ResponsabilidadesPorRol ResponsabilidadPorRol in ResponsabilidadesPorRoles)
                cadena = cadena + " ResponsabilidadPorRol :{ " + ResponsabilidadPorRol.ToString() + "}";
            foreach (RendicionDeCuentasPorRol RendicionDeCuentPorRol in RendicionDeCuentasPorRoles)
                cadena = cadena + " RendicionDeCuentPorRol :{ " + RendicionDeCuentPorRol.ToString() + "}";
            return cadena;
        }
