...
namespace SG_SST.Models.Empresas
{
    ...
    public class ElementoMatriz
    {
        ...
        {
            string cadena = " PK_Elemento_Matriz: " + PK_Elemento_Matriz +
                            " Descripcion_Elemento: " + Descripcion_Elemento +
                            " FK_Matriz: " + FK_Matriz +
                            " TipoElementoAnalisis: " + ((TipoElementoAnalisis == null) ? FK_TipoElementoAnalisis.ToString() : TipoElementoAnalisis.Descripcion_Elemento);            
            return cadena;
        }
    }
}