        ...
        public List<EDIncidente> ConsultarIncidentes(EDIncidente_Modelo_Consulta parametros)
        {
            ...
            try
            {
                using (SG_SSTContext context = new SG_SSTContext())
                {
                    ...
                    DateTime fechaInicial = Convert.ToDateTime(parametros.IncidenteFechaInicial);
                    DateTime fechaFinal = Convert.ToDateTime(parametros.IncidenteFechaFinal);
                    ...
                    if (!parametros.ConsultarTodo)
                    {
                        incidentes = (from i in context.Tbl_Incidentes
                                      ...
                                      where (!parametros.IncidenteFechaInicial.HasValue ||
                                                                                        DbFunctions.TruncateTime(i.Incidente_fecha) >= DbFunctions.TruncateTime(fechaInicial))
                                                                                      && (!parametros.IncidenteFechaFinal.HasValue ||
                                                                                        DbFunctions.TruncateTime(i.Incidente_fecha) <= DbFunctions.TruncateTime(fechaFinal))
                                      ...
                                      select new EDIncidente
                                      {
                                          ...
                                          origenIncidente=i.origenIncidente
                ...
                using (var context = new SG_SSTContext())
                {
                    ...
                    using (var Transaction = context.Database.BeginTransaction())
                    {
                        ...
                        Incidente inct = new Incidente
                        {
                            ...
                            origenIncidente=incidente.origenIncidente
                        };
