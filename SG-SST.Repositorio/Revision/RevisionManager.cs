    ...
    public class RevisionManager : IRevision
    {
                ...
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        var actaGuardada = (from m in context.Tbl_ActaRevision
                                            ...
                                            && m.Fk_Id_Empresa == acta.FK_Empresa
                        ...
                        context.SaveChanges();
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                        {
                            context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(acta.InfoAuditoria,
                                    Enumeraciones.EnumAuditoriaSistema.Acciones.MODIFICACION,
                                    Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                    Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                    Enumeraciones.EnumAuditoriaSistema.Opciones.ModificarActaRevision,
                                    actaGuardada.ToString()));
                            context.SaveChanges();
                        }
                        Transaction.Commit();
        ...
        public EDActaRevision GuardarParticipanteRevision(EDActaRevision acta)
        {
            using (SG_SSTContext context = new SG_SSTContext())
            {
                ...
                ParticipanteRevision part = null;
                using (var Transaction = context.Database.BeginTransaction())
                {
                    RegistraLog registraLog = new RegistraLog();
                    try
                        ...
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                        {
                            if(actaNueva != null)
                            {
                                context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(acta.InfoAuditoria,
                                     ...
                                     Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                     Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                     Enumeraciones.EnumAuditoriaSistema.Opciones.CrearActaRevision,
                                     actaNueva.ToString()));
                                context.SaveChanges();
                            }
                            context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(acta.InfoAuditoria,
                                 ...
                                 Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                 Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                 Enumeraciones.EnumAuditoriaSistema.Opciones.AgregarParticipanteRevision,
                                 part.ToString()));
                            context.SaveChanges();
                        }
                        Transaction.Commit();
        ...
        public List<EDParticipanteRevision> EliminarParticipanteRevision(EDParticipanteRevision participante)
        {
            string Documento = participante.Documento;
            int PK_Id_Acta = participante.FK_ActaRevision;
                ...
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (participanteBorrar != null)
                        {
                            if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                            {
                                context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(participante.InfoAuditoria,
                                    Enumeraciones.EnumAuditoriaSistema.Acciones.ELIMINACION,
                                    Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                    Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                    Enumeraciones.EnumAuditoriaSistema.Opciones.EliminarParticipanteRevision,
                                    participanteBorrar.ToString()));
                            }
                        ...
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                        {
                            if (part != null)
                            {
                                context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(acta.InfoAuditoria,
                                        ...
                                        Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                        Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                        Enumeraciones.EnumAuditoriaSistema.Opciones.CrearAgendaRevision,
                                        part.ToString()));
                                context.SaveChanges();
                            }
                        }
            ...
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                        {
                            context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(tema.InfoAuditoria,
                                    Enumeraciones.EnumAuditoriaSistema.Acciones.MODIFICACION,
                                    Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                    Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                    Enumeraciones.EnumAuditoriaSistema.Opciones.ModificarAgendaRevision,
                                    yaExiste.ToString()));
                            context.SaveChanges();
                        }
                        Transaction.Commit();
        ...
        public List<EDAgendaRevision> EliminarTemaAgendaRevision(EDAgendaRevision agenda)
        {
            int IdTema = agenda.PK_Id_Agenda;
            int PK_Id_Acta = agenda.FK_ActaRevision;
                ...
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (temaBorrar != null)
                        {
                            ...
                            {
                                adjs = adjs + "{" + q.ToString() + "}";
                            }
                            if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                            {
                                context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(agenda.InfoAuditoria,
                                    Enumeraciones.EnumAuditoriaSistema.Acciones.ELIMINACION,
                                    Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                    Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                    Enumeraciones.EnumAuditoriaSistema.Opciones.EliminarAgendaRevision,
                                    temaBorrar.ToString() + adjs));
                            }
                            foreach (AdjuntoAgendaRevision q in adjuntosBorrar)
                            {
        ...
        public List<EDActaRevision> EliminarActaRevision(EDActaRevision acta)
        {
            int PK_Id_Acta = acta.PK_Id_ActaRevision;
                ...
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        foreach (AgendaRevision p in agendaBorrar)
                        {
                            ...
                            age = age + "{" + p.ToString() + adjs + "}";
                           context.Tbl_AgendaRevision.Remove(p);
                        }
                        string pla = " Plan Acción: ";
                        ...
                        if (actaBorrar != null)
                        {
                            if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                            {
                                context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(acta.InfoAuditoria,
                                    ...
                                    Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                    Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                    Enumeraciones.EnumAuditoriaSistema.Opciones.EliminarActaRevision,
                                    actaBorrar.ToString() + par + age + pla));
                            }
            ...
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                        {
                            context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(adjunto.InfoAuditoria,
                                    Enumeraciones.EnumAuditoriaSistema.Acciones.CREACION,
                                    Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                    Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                    Enumeraciones.EnumAuditoriaSistema.Opciones.AdjuntarArchivoAgendaRevision,
                                    nuevo.ToString()));
                            context.SaveChanges();
                        }
                        Transaction.Commit();
        ...
        public List<EDAdjuntoAgendaRevision> EliminarAdjuntoTemaAgendaRevision(EDAdjuntoAgendaRevision adjunto)
        {
            int idAdjunto = adjunto.PK_Id_AdjuntoAgendaRevision; 
            int idAgenda = adjunto.FK_AgendaRevision;
                        ...
                        if (adjuntoBorrar != null)
                        {
                            if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                            {
                                context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(adjunto.InfoAuditoria,
                                    ...
                                    Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                    Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                    Enumeraciones.EnumAuditoriaSistema.Opciones.EliminarArchivoAgendaRevision,
                                    adjuntoBorrar.ToString()));
                            }
            ...
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                        {
                            context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(planaccionrev.InfoAuditoria,
                                    Enumeraciones.EnumAuditoriaSistema.Acciones.CREACION,
                                    Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                    Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                    Enumeraciones.EnumAuditoriaSistema.Opciones.AgregarPlanAccionRevision,
                                    par.ToString()));
                            context.SaveChanges();
                        }
            ...
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaRevisionPorLaDireccion)
                        {
                            context.Tbl_AuditoriaRevisionPorLaDireccionSistema.Add(auditoriaSistema.ObtenerAuditoriaRevisionPorLaDireccion(actarevision.InfoAuditoria,
                                    Enumeraciones.EnumAuditoriaSistema.Acciones.MODIFICACION,
                                    Enumeraciones.EnumAuditoriaSistema.Modulos.Revision_por_la_Direccion,
                                    Enumeraciones.EnumAuditoriaSistema.SubModulos.Revision_del_SG_SST,
                                    Enumeraciones.EnumAuditoriaSistema.Opciones.ModificarActaRevision,
