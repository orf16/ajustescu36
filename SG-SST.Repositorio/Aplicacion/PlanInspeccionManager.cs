...
namespace SG_SST.Repositorio.Aplicacion
{
    public class PlanInspeccionManager : IplanInspeccion
    {
            ...
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        /*inicio auditoria*/
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaEmpresa)
                        {
                            context.Tbl_AuditoriaAplicacionSistema.Add(auditoriaSistema.ObtenerAuditoriaAplicacion(plainspeccione.edInfoauditoria,
                                 Enumeraciones.EnumAuditoriaSistema.Acciones.CREACION,
                                 Enumeraciones.EnumAuditoriaSistema.Modulos.Aplicacion,
                                 Enumeraciones.EnumAuditoriaSistema.SubModulos.Inspecciones_de_Seguridad,
                                 Enumeraciones.EnumAuditoriaSistema.Opciones.Planeacion_de_Inspeccion,
                                 pli.ToString()));
                        }
                        /*fin auditoria*/
            ...
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaEmpresa)
                        {
                            context.Tbl_AuditoriaAplicacionSistema.Add(auditoriaSistema.ObtenerAuditoriaAplicacion(inspeccion.edInfoauditoria,
                                 Enumeraciones.EnumAuditoriaSistema.Acciones.CREACION,
                                 Enumeraciones.EnumAuditoriaSistema.Modulos.Aplicacion,
                                 Enumeraciones.EnumAuditoriaSistema.SubModulos.Inspecciones_de_Seguridad,
                                 Enumeraciones.EnumAuditoriaSistema.Opciones.Planeacion_de_Inspeccion,
            ...
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaEmpresa)
                        {
                            context.Tbl_AuditoriaAplicacionSistema.Add(auditoriaSistema.ObtenerAuditoriaAplicacion(plan.edInfoauditoria,
                                 Enumeraciones.EnumAuditoriaSistema.Acciones.CREACION,
                                 Enumeraciones.EnumAuditoriaSistema.Modulos.Aplicacion,
                                 Enumeraciones.EnumAuditoriaSistema.SubModulos.Inspecciones_de_Seguridad,
                                 Enumeraciones.EnumAuditoriaSistema.Opciones.Planeacion_de_Inspeccion,
                                 planaccioni.ToString()));
                        }
                        /*fin auditoria*/
                        context.SaveChanges();
            ...
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaEmpresa)
                        {
                            context.Tbl_AuditoriaAplicacionSistema.Add(auditoriaSistema.ObtenerAuditoriaAplicacion(condicion.edInfoauditoria,
                                 Enumeraciones.EnumAuditoriaSistema.Acciones.CREACION,
                                 Enumeraciones.EnumAuditoriaSistema.Modulos.Aplicacion,
                                 Enumeraciones.EnumAuditoriaSistema.SubModulos.Inspecciones_de_Seguridad,
                                 Enumeraciones.EnumAuditoriaSistema.Opciones.Planeacion_de_Inspeccion,
        ...
        public bool EliminarInspeccion(int idinspeccion, int idplaneacion, EDInformacionAuditoria edInfoauditoria)
        {
            var result = false;
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var Transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (Eliminado != null)
                        {
                            ...
                            if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaEmpresa)
                            {
                                context.Tbl_AuditoriaAplicacionSistema.Add(auditoriaSistema.ObtenerAuditoriaAplicacion(edInfoauditoria,
                        ...
                        {
                            foreach (var asistentes in asistentesElim)
                            {
                                /*inicio auditoria*/
                                if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaEmpresa)
                                {
                        ...
                        {
                            foreach (var confInspe in configuracionesInspeccion)
                            {
                                /*inicio auditoria*/
                                if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaEmpresa)
                                {
                        ...
                        if (elementosI != null)
                        {
                            foreach (var elemen in elementosI)
                            {
                                /*inicio auditoria*/
                                if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaEmpresa)
                                {
                        ...
                        {
                            foreach (var condiInse in condicionesInsegurasInspeccion)
                            {
                                /*inicio auditoria*/
                                if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaEmpresa)
                                {
