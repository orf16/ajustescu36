            ...
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        {
                            context.Tbl_AuditoriaAplicacionSistema.Add(auditoriaSistema.ObtenerAuditoriaAplicacion(productoCriterio.EDInfoAuditoria,
                                 ...
                                 Enumeraciones.EnumAuditoriaSistema.Opciones.Proveedores_y_Contratistas,
                                 servicioOProducto.ToString()));
                        }
                        /*fin auditoria*/
                ...
                using (var transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        {                            
                            ...
                            if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaOrganizacion)
                            {
                                context.Tbl_AuditoriaAplicacionSistema.Add(auditoriaSistema.ObtenerAuditoriaAplicacion(seleccionEvaluacion.EDInfoAuditoria,
                                     Enumeraciones.EnumAuditoriaSistema.Acciones.CREACION,
                                     Enumeraciones.EnumAuditoriaSistema.Modulos.Aplicacion,
                                     Enumeraciones.EnumAuditoriaSistema.SubModulos.Adquisiciones_Bienes_o_Contratacion,
                                     Enumeraciones.EnumAuditoriaSistema.Opciones.Proveedores_y_Contratistas,
                                     proveedorContratista.ToString()));
                            }
                            /*fin auditoria*/
            ...
            using (SG_SSTContext context = new SG_SSTContext())
            {
                using (var transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaOrganizacion)
                        {
                            SG_SSTContext contextAudi = new SG_SSTContext();
                            ServicioOProducto servicioOProductoAud = contextAudi.Tbl_ServicioOProducto.Find(productocriterio.Pk_id_Tipo_Servicio);
                            context.Tbl_AuditoriaAplicacionSistema.Add(auditoriaSistema.ObtenerAuditoriaAplicacion(productocriterio.EDInfoAuditoria,
                                 Enumeraciones.EnumAuditoriaSistema.Acciones.MODIFICACION,
                                 Enumeraciones.EnumAuditoriaSistema.Modulos.Aplicacion,
                                 Enumeraciones.EnumAuditoriaSistema.SubModulos.Adquisiciones_Bienes_o_Contratacion,
                                 Enumeraciones.EnumAuditoriaSistema.Opciones.Proveedores_y_Contratistas,
                                 servicioOProductoAud.ToString()));
                        }
                        /*fin auditoria*/
                        ServicioOProducto servicioOProducto = new ServicioOProducto();
                        servicioOProducto.Nombre_ServicioOProducto = productocriterio.Tipo_Servicio;
                        ...
                        foreach (ProductoPorCriterio produCriterio in productoPorCriterios)
                            /*inicio auditoria*/
                            if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaOrganizacion)
                            {                                
                                context.Tbl_AuditoriaAplicacionSistema.Add(auditoriaSistema.ObtenerAuditoriaAplicacion(productocriterio.EDInfoAuditoria,
                ...
                using (var transaction = context.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        /*inicio auditoria*/
                            if (context.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaOrganizacion)
                            {
                                context.Tbl_AuditoriaAplicacionSistema.Add(auditoriaSistema.ObtenerAuditoriaAplicacion(ProveedorContratista.edInfoauditoria,
                                     Enumeraciones.EnumAuditoriaSistema.Acciones.MODIFICACION,
                                     Enumeraciones.EnumAuditoriaSistema.Modulos.Aplicacion,
                                     Enumeraciones.EnumAuditoriaSistema.SubModulos.Adquisiciones_Bienes_o_Contratacion,
                                     Enumeraciones.EnumAuditoriaSistema.Opciones.Proveedores_y_Contratistas,
