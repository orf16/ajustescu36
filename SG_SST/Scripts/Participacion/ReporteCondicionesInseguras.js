...
//funcion que me permite eliminar un imagen delreportr
function EliminarReporteCondicinesInseguras(element, id_Reporte) {
    $div = $(element).closest("tr");
    var ipUsu = $("#ip").val();
    $.ajax({
        url: urlBase + urlReporte + '/EliminarReporteActaCondicion',
        data: {
           FK_Id_Reporte: id_Reporte,
         Ip: ipUsu
        },
        type: 'POST',
        success: function (result) {
            ...
            if (result.success) {
                $("#modalesEliminados").append($("#modalEliminar" + id_Reporte));
                $div.remove();
			  ...
			  window.location.href = "Index";
                ...
                swal({
                    type: 'warning',
                    title: 'Estimado usuario:',
                    text: 'El reporte  no puede ser eliminado porque ya tiene cerradas una o más actividades del plan de acción.',
