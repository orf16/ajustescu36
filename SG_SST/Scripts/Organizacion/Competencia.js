    ...
    $.ajax({
        ...
        success: function (result) {
            if (result) {
                ...
                $.each(result, function (ind, element) {
                    var $tr = "<tr class='titulos_filas' name='tem' ><td name='tdtema' style='border-right: 2px solid lightslategray; vertical-align:middle'>" + element.Descripcio_Tematicas + " <input name= 'idtePos' type='hidden' value = " + element.Id_Tematica + " <input name= 'temaPos' type='hidden' value = " + element.Tematicas + " <input name= 'tipoTem' type='hidden' value = " + element.TipoTematica + " > </td>";
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result) {
                ...
                $.each(result, function (ind, element) {
                    var $tr = "<tr class='titulos_filas'  name='temEmp' id=" + element.Id_Tematica + "><td name='tdtemaEmp' style='border-right: 2px solid lightslategray; vertical-align:middle'>" + element.Descripcio_Tematicas + " <input name= 'idtePosEmp' type='hidden' value = " + element.Id_Tematica + "><input name= 'temaPosEmp' type='hidden' value = " + element.Descripcio_Tematicas + " ><input name= 'tipoTemEmp' type='hidden' value = " + element.TipoTematica + "><input name= 'tipoTemEmp' type='hidden' value = " + element.NombreDocumento + "></td>";
                    $tr = $tr + '<td style="border-right: 2px solid lightslategray; text-align:center; vertical-align:middle">';
                    ...
                    $tr = $tr + "</td><td style='border-right: 2px solid lightslategray; vertical-align:middle; text-align:center'><a onclick='AgregarASeleccionadasEmp(this, " + element.Id_Tematica + ")' name='seleccionarTematicaEmp'><span name='adicionar' class='glyphicon glyphicon-plus'></span></a></td> </tr>";
...
function pregunta() {
    ...
    var separarTrabajadores = addedTrabajador.join('|');
    document.getElementById("idEmpleados").value = separarTrabajadores;
