...
$(document).ready(function () {
    ...
    $("#ConsultarIndidentes").click(function () {
        ...
        if ($.datepicker.parseDate('dd/mm/yy', datos.FechaInicial) > $.datepicker.parseDate('dd/mm/yy', datos.FechaFinal)) {
        ...
        //    return false;
        //}
        if ($.datepicker.parseDate('dd/mm/yy', datos.FechaInicial) > temp) {
            swal("Estimado Usuario", 'La fecha de inicio no puede ser mayor que la fecha actual')
            return false;
        }
        PopupPosition();
