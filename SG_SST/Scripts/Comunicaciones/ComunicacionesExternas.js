...
function GuardarComunicado(origen) {
    ...
    if ($("#frmcomunicacionesexternas").valid()) {
        ...
        $.ajax({
            ...
            data: { PK_Id_Comunicado: $("#PK_Id_Comunicado").val(), Titulo: $("#Titulo").val(), Asunto: $("#Asunto").val(), CuerpoMensaje: tinyMCE.get('CuerpoMensaje').getContent(), arreglo: arreglo, Origen: origen, esEncuesta: esEncuesta },
