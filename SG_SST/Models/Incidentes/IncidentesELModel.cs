...
namespace SG_SST.Models.Incidentes
{
    public class IncidentesELModel
    {
        ...
        public int PK_Incidentes_EL_Id1 { get; set; }
        public int PK_Incidentes_EL_Id2 { get; set; }
        public int PK_Incidentes_EL_Id3 { get; set; }
        public int PK_Incidentes_EL_Id4 { get; set; }
        public int PK_Incidentes_EL_Id5 { get; set; }
        public int PK_Incidentes_EL_Id6 { get; set; }
        public int PK_Incidentes_EL_Id7 { get; set; }
        public int PK_Incidentes_EL_Id8 { get; set; }
        public int PK_Incidentes_EL_Id9 { get; set; }
        public int PK_Incidentes_EL_Id10 { get; set; }
        public List<SelectListItem> tyears { get; set; }
        public List<SelectListItem> tmonth { get; set; }
        public List<SelectListItem> tdays { get; set; }
        ...
        public string TempEmpleadorII { get; set; }
