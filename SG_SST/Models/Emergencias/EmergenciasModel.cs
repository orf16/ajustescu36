...
namespace SG_SST.Models.Emergencias
{
    public class EmergenciasModel
    {
        ...
        public HttpPostedFileBase adjuntoPAM { get; set; }
        ...
        public bool bo_ZonaIndustrial { get; set; }

        public bool bo_ZonaResidencial { get; set; }

        public bool bo_ZonaComercial { get; set; }

        public bool bo_ZonaMixta { get; set; }
        ...
        public string plan_AtencionMedica { get; set; }
        public string plan_Evacuacion { get; set; }
        public string plan_contraincendios { get; set; }
        public string plan_seguridadfisica_img { get; set; }
        public string plan_AtencionMedica_img { get; set; }
        public string plan_contraincendios_img { get; set; }
        public string plan_Evacuacion_img { get; set; }
        public string plan_rutas_evac_img { get; set; }
        ...
        public string nuevoAspectoVulPer { get; set; }
        public string tipoVulPer { get; set; }
        
        public string Fk_SedeVulPer { get; set; }

        //Vul Recursos

        public string nuevoAspectoVulRec { get; set; }
        public string tipoVulRec { get; set; }
    
        public string Fk_SedeVulRec { get; set; }

        // Vul SistemasYProcesos

        public string nuevoAspectoVulSYP { get; set; }
        public string tipoVulSYP { get; set; }

        public string Fk_SedeVulSYP { get; set; }

        // Plan de Ayuda Mutua

        public int Fk_SedePlanAyuda{get;set;}
        public string empresaParticipante {get;set;}

        public string recursosDisposicion{get;set;}

        public string compesacionEconomica{get;set;}

        public string reintegroDelRecurso{get;set;}

        public string nombreDelContactoAM{get;set;}

        public string telefonoDeContactoAM{get;set;}

        //BD Externa

        public string entidadBE { get; set; }
        public string direccionBE { get; set; }
        public string telefonoBE { get; set; }

        public string contactoBE { get; set; }

        public int Fk_SedeBDExterna { get; set; }

        // BD Interna

        public int Fk_SedeBDInterna { get; set; }
        public string documentoBI { get; set; }
        public string nombreBI { get; set; }
        public string sexoBI { get; set; }
        public string epsBI { get; set; }
        public string grupoRHBI { get; set; }
        public string nombreContactoBI { get; set; }
        public string telefonoContactoBI { get; set; }
        public string ParentescoBI { get; set; }
        public string requiereManejoBI { get; set; }

        public string CualBI { get; set; }
