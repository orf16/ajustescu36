...
namespace SG_SST.Controllers.Participacion
{
    ...
    public class ReporteController : BaseController
    {
        ...
        //Eliminar 
        string ValidarExistePlanCondicionesInseguras = ConfigurationManager.AppSettings["ValidarExistePlanCondicionesInseguras"];
        string eliminarReportesCondicionesInseguras = ConfigurationManager.AppSettings["eliminarReportesCondicionesInseguras"];
