...
namespace SG_SST.Controllers.Empresas
{
    ...
    public class UsuariosController : BaseController
    {
        ...
        [AllowAnonymous]
        public ActionResult IndexListaUsuarios()
        {
            var usuarioActual = ObtenerUsuarioEnSesion(System.Web.HttpContext.Current);
            if (usuarioActual == null)
            {
     ...
     //   [ValidateAntiForgeryToken]
        ...
        [HttpPost]
     //   [ValidateAntiForgeryToken]
        public ActionResult Edit(Usuario usuario, HttpPostedFileBase Firma, List<int> Fk_Id_Rol, string ipUsuario)
        {
            var usuarioActual = ObtenerUsuarioEnSesion(System.Web.HttpContext.Current);
            if (usuarioActual == null)
            {
            ...
            if (db.Tbl_ActivaAuditoriaSistema.ToList().FirstOrDefault().EsActivaEmpresa)
            {
                ...
                Usuario userAudi = dbAud.Tbl_Usuario.Find(usuario.Pk_Id_Usuario);
                db.Tbl_AuditoriaEmpresaSistema.Add(auditoriaSistema.ObtenerAuditoriaSistemaEmpresa(edInfoauditoria,
