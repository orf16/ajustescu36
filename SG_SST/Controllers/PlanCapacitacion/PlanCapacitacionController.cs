...
namespace SG_SST.Controllers.PlanCapacitacion
{
    ...
    public class PlanCapacitacionController : BaseController
    {
        ...
        private void SetDDL()
        {
            ...
            lst.Add(new SelectListItem() { Text = "-Seleccione Opción-", Value = "0" });
            lst.Add(new SelectListItem() { Text = "Capacitación", Value = "1" });
            lst.Add(new SelectListItem() { Text = "Entrenamiento", Value = "2" });
            lst.Add(new SelectListItem() { Text = "Inducción/RE inducción", Value = "3" });
            ...
            lst1.Add(new SelectListItem() { Text = "-Seleccione Opción-", Value = "0" });
            ...
            lst2.Add(new SelectListItem() { Text = "-Seleccione Opción-", Value = "0" });
