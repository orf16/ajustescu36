...
namespace SG_SST.Controllers.Base
{
    ...
    public class BaseController : Controller
    {
        ...
        public string rutaFisicaDocumentosPdfAutorizacion = ConfigurationManager.AppSettings["RutaFisicaDocumentosPdfAutorizacion"];
        public string rutaHttpSoporteAutorizacionAsesorSST = ConfigurationManager.AppSettings["RutaSoporteAutorizacionAsesorSST"];
        ...
        public string periodoInactivacionUsuario = ConfigurationManager.AppSettings["PeriodoInactivacionUsuario"];
