    ...
    public class RecursosController : BaseController
    {
       ...
       [AllowAnonymous]
        ...
        public ActionResult Recursos_PDF(int Pk_Id_Sede, int Periodo)
        {
            ...
            string EncodedNombreInforme = System.Net.WebUtility.UrlEncode("Recursos Asignados Sede");
            ...
            return new Rotativa.PartialViewAsPdf("RecursosPorSedePDF", data) { FileName = "Recursos Asignados Sede.pdf", CustomSwitches = cusomtSwitches };
        }
