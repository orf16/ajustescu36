...
namespace SG_SST.Controllers
{
    ...
    public class HomeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            if (usuario != null)
            {
                ...
                if (Session["pkempresa"] == null)
                {
                    ...
                    Session["RecursosPorRol"] = lnUsuario.ObtenerRecursosPorRol(resultado.IdRol, resultado.CodEmpresa).Select(rs => new RecursosPorRolModel { Controlador = rs.Controlador, Accion = rs.Accion }).ToList();
                    Session["RecursosPorRolMostrar"] = lnUsuario.ObtenerRecursosPorRolMenu(resultado.IdRol, resultado.CodEmpresa).Select(rs => new RecursosPorRolMenuModel { NombreRecursoSistema = rs.NombreRecursoSistema, IdRecursoSistema = rs.IdRecursoSistema }).ToList();
                }
        ...
        public ActionResult MostrarAccesoDenegado()
        {
            return View();
        }
        /// <summary>
