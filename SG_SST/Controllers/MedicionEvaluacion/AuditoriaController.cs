        ...
        public ActionResult ReporteInforme(string IdAuditoria)
        {
            ...
            if (IdAuditoria != null)
            {
                ...
                if (url.Contains("gov"))
                {
                    ...
                    {
                        FileName = "Alissta_InformeAuditoria" + DateTime.Now.ToString().Replace("/", "").Replace(":", "").Replace(" ", "") + ".pdf"
                        ,
                ...
                if (url.Contains("localhost"))
                {
                    ...
                    var headerurl = "http://localhost:3163/Acciones/Header?NombreEmpresa=" + EncodedRazonSocial + "&NitEmpresa=" + EncodedNit + "&NombreInforme=" + EncodedNombreInforme;
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://localhost:3163/Auditoria/AuditoriaPDF?IdAuditoria=" + IdAuditoria.ToString() + "&NitEmpresa=" + EncodedNit;
                ...
                if (url.Contains("test"))
                {
                    ...
                    var headerurl = "http://test-positiva.adacsc.co/Acciones/Header?NombreEmpresa=" + EncodedRazonSocial + "&NitEmpresa=" + EncodedNit + "&NombreInforme=" + EncodedNombreInforme;
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://test-positiva.adacsc.co/Auditoria/AuditoriaPDF?IdAuditoria=" + IdAuditoria.ToString() + "&NitEmpresa=" + EncodedNit;
                ...
                if (url.Contains("adacsc"))
                {
                    ...
                    var headerurl = "http://positiva.adacsc.co/Acciones/Header?NombreEmpresa=" + EncodedRazonSocial + "&NitEmpresa=" + EncodedNit + "&NombreInforme=" + EncodedNombreInforme;
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://positiva.adacsc.co/Auditoria/AuditoriaPDF?IdAuditoria=" + IdAuditoria.ToString() + "&NitEmpresa=" + EncodedNit;
        ...
        public ActionResult ReportePlan(string IdAuditoria)
        {
            ...
            if (IdAuditoria != null)
            {
                ...
                if (url.Contains("gov"))
                {
                    ...
                    return new Rotativa.UrlAsPdf(ReporteUrl)
                    {
                        FileName = "Alissta_ReportePlanAuditoria" + DateTime.Now.ToString().Replace("/", "").Replace(":", "").Replace(" ", "") + ".pdf"
                        ,
                        CustomSwitches = cusomtSwitches
                        ,
                        PageSize = Rotativa.Options.Size.Letter
                ...
                if (url.Contains("localhost"))
                {
                    ...
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://localhost:3163/Auditoria/PlanPDF?IdAuditoria=" + IdAuditoria.ToString() + "&NitEmpresa=" + EncodedNit;
                ...
                if (url.Contains("test"))
                {
                    ...
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://test-positiva.adacsc.co/Auditoria/PlanPDF?IdAuditoria=" + IdAuditoria.ToString() + "&NitEmpresa=" + EncodedNit;
                ...
                if (url.Contains("adacsc"))
                {
                    ...
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://positiva.adacsc.co/Auditoria/PlanPDF?IdAuditoria=" + IdAuditoria.ToString() + "&NitEmpresa=" + EncodedNit;
        ...
        public ActionResult ReporteLista(string IdAuditoria)
        {
            ...
            if (IdAuditoria != null)
            {
                ...
                if (url.Contains("gov"))
                {
                    ...
                    return new Rotativa.UrlAsPdf(ReporteUrl)
                    {
                        FileName = "ReporteListaVerificacion" + DateTime.Now.ToString().Replace("/", "").Replace(":", "").Replace(" ", "") + ".pdf"
                        ,
                        CustomSwitches = cusomtSwitches
                        ,
                        PageSize = Rotativa.Options.Size.Letter
                ...
                if (url.Contains("localhost"))
                {
                    ...
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://localhost:3163/Auditoria/ListaPDF?IdAuditoria=" + IdAuditoria.ToString() + "&NitEmpresa=" + EncodedNit;
                ...
                if (url.Contains("test"))
                {
                    ...
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://test-positiva.adacsc.co/Auditoria/ListaPDF?IdAuditoria=" + IdAuditoria.ToString() + "&NitEmpresa=" + EncodedNit;
                ...
                if (url.Contains("adacsc"))
                {
                    ...
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://positiva.adacsc.co/Auditoria/ListaPDF?IdAuditoria=" + IdAuditoria.ToString() + "&NitEmpresa=" + EncodedNit;
        ...
        public ActionResult ReportePrograma(string IdPrograma)
        {
            ...
            if (IdPrograma != null)
            {
                ...
                if (url.Contains("gov"))
                {
                    ...
                    return new Rotativa.UrlAsPdf(ReporteUrl)
                    {
                        FileName = "Alissta_ProgramaAuditoria" + DateTime.Now.ToString().Replace("/", "").Replace(":", "").Replace(" ", "") + ".pdf"
                        ,
                        CustomSwitches = cusomtSwitches
                        ,
                        PageSize = Rotativa.Options.Size.Letter
                ...
                if (url.Contains("localhost"))
                {
                    ...
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://localhost:3163/Auditoria/ProgramaPDF?IdPrograma=" + IdPrograma.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
                ...
                if (url.Contains("test"))
                {
                    ...
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://test-positiva.adacsc.co/Auditoria/ProgramaPDF?IdPrograma=" + IdPrograma.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
                ...
                if (url.Contains("adacsc"))
                {
                    ...
                    string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                    footurl, headerurl);
                    var ReporteUrl = "http://positiva.adacsc.co/Auditoria/ProgramaPDF?IdPrograma=" + IdPrograma.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
