        ...
        public ActionResult UrlAsPDF(string id)
        {
            ...
            else 
            {
                if (url.Contains("localhost"))
                {
                    ...
                    var ReporteUrl = "http://localhost:3163/Acciones/AccionPDF?id=" + Id_Accion.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
                ...
                if (url.Contains("test"))
                {
                    ...
                    var ReporteUrl = "http://test-positiva.adacsc.co/Acciones/AccionPDF?id=" + Id_Accion.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
                ...
                if (url.Contains("positiva.adacsc.co"))
                {
                    string EncodedRazonSocial = System.Net.WebUtility.UrlEncode(usuarioActual.RazonSocialEmpresa);
                    string EncodedNit = System.Net.WebUtility.UrlEncode(usuarioActual.NitEmpresa);
                    string EncodedNombreInforme = System.Net.WebUtility.UrlEncode("ACCIÓN PREVENTIVA O CORRECTIVA");
                    ...
                    var ReporteUrl = "http://positiva.adacsc.co/Acciones/AccionPDF?id=" + Id_Accion.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
