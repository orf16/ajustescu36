...
namespace SG_SST.Controllers.Planificacion
{
    ...
    public class PerfilSocioDemoGraficoController : BaseController
    {
        ...
        [HttpPost]
        public ActionResult GrabarPerfilSocioDemografico(EDPerfilSocioDemografico varperfilsocidemografico, List<EDCondicionesRiesgoPerfil> condicionesRiesgo, string ipUsuario)
        {
            ...
            try
            {
                ...
                varperfilsocidemografico.EDInfoAuditoria = edInfoauditoria;
                ServiceClient.EliminarParametros();
            ...
            {
                ViewBag.esActivo = true;
                return View("Listado");
            }
        }

        [AllowAnonymous]
        public ActionResult EditarPerfilSocioDemografico(EDPerfilSocioDemografico varperfilsocidemografico, List<EDCondicionesRiesgoPerfil> condicionesRiesgo, string ipUsuario)
        {
        ...
        public ActionResult Listado()
        {
            ...
            List<EDPerfilSocioDemografico> proceso = new List<EDPerfilSocioDemografico>();
            try
            {
        ...
        [AllowAnonymous]
        public ActionResult Edit(int? id, string doc)
        {
