...
namespace SG_SST.Controllers.LiderazgoGerencial
{
    ...
    public class RolController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult CrearRolResponsabilidad(Rol rol, List<Responsabilidades> responsabilidad, List<RendicionDeCuentas> rendicion, string ipUsuario)
        {
            ...
            bool respuestaGuardado = rolPorResponsabilidadServicio.GuardarRolYResponsabilidades(rol, responsabilidad, rendicion, usuarioActual.IdEmpresa, edInfoauditoria);
        ...
        public ActionResult DeleteConfirmed(int id, string ipUsuario)
        {
            ...
            bool respuestaEliminado = rolPorResponsabilidadServicio.EliminarRolYResponsabilidades(id, edInfoauditoria);
