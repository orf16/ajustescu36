...
namespace SG_SST.Controllers.Aplicacion
{
    ...
    public class CriteriosSSTController : BaseController
    {
        ...
        [HttpPost]
        public ActionResult Calificar(EDSeleccionYEvaluacion seleccionEvaluacion, List<HttpPostedFileBase> files, string ipUsuario)
        {
            var usuarioActual = ObtenerUsuarioEnSesion(System.Web.HttpContext.Current);
            if (usuarioActual == null)
            {
        ...
        public ActionResult EdicionProductoPorCriterios(EDProductoCriterio productocriterio, string ipUsuario)
        {
            var usuarioActual = ObtenerUsuarioEnSesion(System.Web.HttpContext.Current);
            if (usuarioActual == null)
            {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        public ActionResult DeleteConfirmed(int idProducto, string ipUsuario)
        {
            var usuarioActual = ObtenerUsuarioEnSesion(System.Web.HttpContext.Current);
            if (usuarioActual == null)
            {
            ...
            bool respuestaEliminado = ServiceClient.PeticionesPostJsonRestFulRespuetaBool(urlAplicacion, CapacidadEliminarProductoCriterio, RestSharp.Method.DELETE, edInfoauditoria);
            //bool resultMetodologias = ServiceClient.PeticionesPostJsonRestFulRespuetaBool(urlPlanificacion, CapacidadEliminarDxGralDeSaludGeneral, RestSharp.Method.DELETE, edInfoauditoria);
