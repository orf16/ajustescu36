...
namespace SG_SST.Controllers.Aplicacion
{
    ...
    public class BateriaGestionController : BaseController
    {
        ...
        public ActionResult Configurar(string IdGestion)
        {
            ...
            if (int.TryParse(IdGestion, out IdGestionInt))
            {
                verificar(IdGestionInt, usuarioActual.IdEmpresa);
                EDBateriaGestion = LNBateria.ConsultarGestion(IdGestionInt, usuarioActual.IdEmpresa);
        ...
        public ActionResult ResultadoGeneral(string IdGestion, int form)
        {
            ...
            {
                if (itemUs.Pk_Id_BateriaUsuario== 7802)
                {
                    string jhjk = "";
                }
                ...
                if (EDBateriaGestionConsulta.Fk_Id_Bateria == 1 && itemUs.NumeroIntentos == 1)
                {
                    ...
                    //Si en la encuesta inicial existe un problema por defecto se asigna como si fuera auxiliar o administrativo
                    if (itemUs.BateriaInicial.TipoCargo == null)
                    {
                        EDBateriaInicial inicialintra = LNBateria.ConsultarInicialSoloIntra(itemUs.Pk_Id_BateriaUsuario, usuarioActual.IdEmpresa);
                        if (inicialintra != null)
                        {
                            if (inicialintra.TipoCargo == "Jefatura - tiene personal a cargo" || inicialintra.TipoCargo == "Profesional, analista, técnico, tecnólogo")
                            {
                                tipo = 1;
                                evalriesgo = baremosExtra1();
                                evalriesgoDom = baremosExtra1();
                            }
                            if (inicialintra.TipoCargo == "Auxiliar, asistente administrativo, asistente técnico" || inicialintra.TipoCargo == "Operario, operador, ayudante, servicios generales")
                            {
                                tipo = 2;
                                evalriesgo = baremosExtra2();
                                evalriesgoDom = baremosExtra2();
                ...
                if (EDBateriaGestionConsulta.Fk_Id_Bateria == 4)
                {
                    ...
                    if (itemUs.ListaResultados.Count!=0)
                    {
        ...
        public ActionResult ResultadoExcel(string IdGestion, int form)
        {
            ...
            if (int.TryParse(IdGestion, out IdGestionInt))
            {
                EDBateriaGestionConsulta = LNBateria.ConsultarGestionResultadoGeneral(IdGestionInt, usuarioActual.IdEmpresa);
                ViewBag.Nombre = EDBateriaGestionConsulta.NombreBateria.Replace("Estres", "Estrés");
            }
            //Consulta Usuarios terminados
            List<EDBateriaUsuario> ListaUsuariosTerminados = new List<EDBateriaUsuario>();
            ...
            using (ExcelPackage wb = new ExcelPackage())
            {
                ...
                string NombreEncuesta = string.Empty;
                string NombreEncuestaTotal = string.Empty;
                double FactorTransformacion = 0;
                    ...
                    #region CalculoValores&riesgo
                        if (ListaDominios.Count==0)
                        {
                            ...
                            if (EDBateriaGestionConsulta.Fk_Id_Bateria == 1 && itemUs.NumeroIntentos == 0)
                            {
                                ...
                                NombreEncuestaTotal= "TOTAL GENERAL FACTORES DE RIESGO PSICOSOCIAL INTRALABORAL";
                                NombreEncuesta = "Cuestionario de Factores de Riesgo Psicosocial Intralaboral FORMA A";
                                nombrePrincipal = "Cuestionario de Factores de Riesgo Psicosocial Intralaboral FORMA A";
                                FactorTransformacion = 492;
                            ...
                            if (EDBateriaGestionConsulta.Fk_Id_Bateria == 2 && itemUs.NumeroIntentos == 0)
                            {
                                ...
                                NombreEncuestaTotal = "TOTAL GENERAL FACTORES DE RIESGO PSICOSOCIAL INTRALABORAL";
                                NombreEncuesta = "Cuestionario de Factores de Riesgo Psicosocial Intralaboral FORMA B";
                                nombrePrincipal = "Cuestionario de Factores de Riesgo Psicosocial Intralaboral FORMA B";
                                FactorTransformacion = 388;
                            ...
                            if (EDBateriaGestionConsulta.Fk_Id_Bateria == 1 && itemUs.NumeroIntentos == 1)
                            {
                                ...
                                NombreEncuestaTotal = "TOTAL GENERAL FACTORES DE RIESGO PSICOSOCIAL EXTRALABORAL";
                                NombreEncuesta = "Cuestionario de Factores de Riesgo Psicosocial Extralaboral";
                                nombrePrincipal = "Cuestionario de Factores de Riesgo Psicosocial Extralaboral";
                                FactorTransformacion = 124;
                            ...
                            if (EDBateriaGestionConsulta.Fk_Id_Bateria == 4)
                            {
                                ...
                                NombreEncuestaTotal = "TOTAL GENERAL SÍNTOMAS DE ESTRÉS";
                                NombreEncuesta = "Cuestionario de Factores de Estrés";
                                nombrePrincipal = "Cuestionario de Factores de Estrés";
                                FactorTransformacion = 61.16;
                        ...
                        itemUs.NombreEncuestaTotal = NombreEncuestaTotal;
                        itemUs.NombreEncuesta = NombreEncuesta;
                        itemUs.FactorTransformacion = FactorTransformacion;
            ...
            if (IdUsuario != null)
            {
                ...
                if (int.TryParse(IdUsuario, out IdUsuarioInt))
                {
                    ...
                    if (EDBateriaGestion.Fk_Id_Bateria == 1 && EDBateriaUsuario.NumeroIntentos == 1)
                    {
                        ...
                        if (EDBateriaUsuario.BateriaInicial.TipoCargo == null)
                        {
                            EDBateriaInicial inicialintra = LNBateria.ConsultarInicialSoloIntra(IdUsuarioInt, usuarioActual.IdEmpresa);
                            if (inicialintra != null)
                            {
                                if (inicialintra.TipoCargo == "Jefatura - tiene personal a cargo" || inicialintra.TipoCargo == "Profesional, analista, técnico, tecnólogo")
                                {
                                ...
                                EDBateriaUsuario.BateriaInicial = inicialintra;
                    ...
                    if (EDBateriaGestion.Fk_Id_Bateria == 4)
                    {
                        ...
                        int cont1 = 1;
                        EDBateriaUsuario.PuntajeTrans = (EDBateriaUsuario.Puntaje / (decimal)EDBateriaUsuario.FactorTransformacion) * 100;
                        if (EDBateriaUsuario.PuntajeTrans > 100)
                        {
                            EDBateriaUsuario.PuntajeTrans = 100;
                        }
                        EDBateriaUsuario.Listadominios = new List<EDBateriaDominio>();
                        EDBateriaUsuario.Listadominios = ListaDominios;
                        decimal[, ,] evalriesgoTotal = new decimal[10, 10, 10];
            ...
            if (id != null)
            {
                ...
                if (int.TryParse(id, out IdUsuarioInt))
                {
                    ...
                    if (EDBateriaGestion.Fk_Id_Bateria == 1 && EDBateriaUsuario.NumeroIntentos == 1)
                    {
                        ...
                        if (EDBateriaUsuario.BateriaInicial.TipoCargo==null)
                        {
                            EDBateriaInicial inicialintra = LNBateria.ConsultarInicialSoloIntra(IdUsuarioInt, IdEmpresa);
                            if (inicialintra!=null)
                            {
                                if (inicialintra.TipoCargo == "Jefatura - tiene personal a cargo" || inicialintra.TipoCargo == "Profesional, analista, técnico, tecnólogo")
                                {
        ...
        public ActionResult UrlAsPDF(string IdUsuario)
        {
            ...
            if (url.Contains("gov"))
            {
                ...
                var headerurl = "https://alissta.gov.co/Acciones/Header?NombreEmpresa=" + EncodedRazonSocial.Replace(" ", "%") + "&NitEmpresa=" + EncodedNit + "&NombreInforme=" + EncodedNombreInforme;
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "https://alissta.gov.co/BateriaGestion/InformePDF?id=" + IdUsuario.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString() + "&RazonSocialEmpresa=" + usuarioActual.RazonSocialEmpresa.Replace(" ", "%");
            ...
            if (url.Contains("localhost"))
            {
                ...
                string EncodedNit = System.Net.WebUtility.UrlEncode(usuarioActual.NitEmpresa);
                string EncodedNombreInforme = System.Net.WebUtility.UrlEncode("INFORME DE RESULTADOS DEL CUESTIONARIO");
                var footurl = "http://localhost:3163/Acciones/Footer";
                var headerurl = "http://localhost:3163/Acciones/Header?NombreEmpresa=" + EncodedRazonSocial.Replace(" ", "%") + "&NitEmpresa=" + EncodedNit + "&NombreInforme=" + EncodedNombreInforme;
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://localhost:3163/BateriaGestion/InformePDF?id=" + IdUsuario.ToString() + "&NitEmpresa=" + EncodedNit + "&RazonSocialEmpresa=" + usuarioActual.RazonSocialEmpresa.Replace(" ", "%") + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
            ...
            if (url.Contains("test"))
            {
                ...
                string EncodedNit = System.Net.WebUtility.UrlEncode(usuarioActual.NitEmpresa);
                string EncodedNombreInforme = System.Net.WebUtility.UrlEncode("INFORME DE RESULTADOS DEL CUESTIONARIO");
                var footurl = "http://test-positiva.adacsc.co/Acciones/Footer";
                var headerurl = "http://test-positiva.adacsc.co/Acciones/Header?NombreEmpresa=" + EncodedRazonSocial.Replace(" ", "%") + "&NitEmpresa=" + EncodedNit + "&NombreInforme=" + EncodedNombreInforme;
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://test-positiva.adacsc.co/BateriaGestion/InformePDF?id=" + IdUsuario.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString() + "&RazonSocialEmpresa=" + usuarioActual.RazonSocialEmpresa.Replace(" ", "%");
            ...
            if (url.Contains("adacsc"))
            {
                string EncodedRazonSocial = System.Net.WebUtility.UrlEncode(usuarioActual.RazonSocialEmpresa);
                string EncodedNit = System.Net.WebUtility.UrlEncode(usuarioActual.NitEmpresa);
                string EncodedNombreInforme = System.Net.WebUtility.UrlEncode("INFORME DE RESULTADOS DEL CUESTIONARIO");
                var footurl = "http://positiva.adacsc.co/Acciones/Footer";
                var headerurl = "http://positiva.adacsc.co/Acciones/Header?NombreEmpresa=" + EncodedRazonSocial.Replace(" ", "%") + "&NitEmpresa=" + EncodedNit + "&NombreInforme=" + EncodedNombreInforme;
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://positiva.adacsc.co/BateriaGestion/InformePDF?id=" + IdUsuario.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString() + "&RazonSocialEmpresa=" + usuarioActual.RazonSocialEmpresa.Replace(" ", "%");
        ...
        private void verificar(int IdGestion, int IdEmpresa)
        {
            if (TempData["verificarbaterias"] == null)
            {
                LNBateria.VerificarEncuestas(IdGestion, IdEmpresa);
                TempData["verificarbaterias"] = IdGestion;
                TempData.Keep("verificarbaterias");
            }
            else
            {
                if ((int)TempData["verificarbaterias"]!= IdGestion)
                {
                    LNBateria.VerificarEncuestas(IdGestion, IdEmpresa);
                    TempData["verificarbaterias"] = IdGestion;
                }
