...
namespace SG_SST.Controllers.Aplicacion
{
    ...
    public class PlandeInspeccionController : BaseController
    {
        ...
        public ActionResult CrearPlaneacionInspeccion(PlanInspeccionModel planInspeccion, string ipUsuario)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var planinspecciones = new EDPlanInspeccion()
                {
                    ...
                    edInfoauditoria = edInfoauditoria
                };
                ServiceClient.EliminarParametros();
        ...
        public ActionResult Inspecciones_Pdf()
        {
            ...
            string EncodedNombreInforme = System.Net.WebUtility.UrlEncode("Resumen Inspecciones");
            ...
            return new Rotativa.PartialViewAsPdf("ResumenGeneralInspecciones", resumen) { FileName = "ResumenGralInspeccion.pdf", CustomSwitches = cusomtSwitches };
       }
        ...
        /// <returns></returns>
        public ActionResult EliminarInspeccion(int IdInspeccion, int IdPlaneacion, string ipUsuario)
        {
            var usuarioActual = ObtenerUsuarioEnSesion(System.Web.HttpContext.Current);
            if (usuarioActual == null)
            {
            ...
            var resultEliminar = ServiceClient.PeticionesPostJsonRestFulRespuetaBool(UrlServicioAplicacion, EliminarInspecciones, RestSharp.Method.DELETE, edInfoauditoria);
        ...
        public ActionResult ObtenerFormularioCondicion(ObtenerCondicionVM crearmodel, string ipUsuario)
        {
        ...
        /// <returns></returns>
        [AllowAnonymous]
        public ActionResult GuardarCondicionesInseguras(CondicionesVModel condiciones, string ipUsuario)
        {
            List<EDCondicionInsegura> condicionesIns = new List<EDCondicionInsegura>();
            var usuarioActual = ObtenerUsuarioEnSesion(System.Web.HttpContext.Current);
            if (usuarioActual == null)
        ...
        /// <returns></returns>
        public ActionResult GuardarPlanesAccion(PlanAccionVM plan, string ipUsuario)
        {
            var sw = false;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult ModificarCondicion(CondicionesVModel condiciones, string ipUsuario)
        {
            var usuarioActual = ObtenerUsuarioEnSesion(System.Web.HttpContext.Current);
            if (usuarioActual == null)
            {
