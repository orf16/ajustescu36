    ...
    public class AdmoEPPController : BaseController
    {
        ...
        public ActionResult ExportMatrizPDF(string resultado, int IdEmpresa)
        {
            ...
            if (url.Contains("gov"))
            {
                ...
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://localhost:3163/AdmoEPP/MatrizEPPPDF?id=" + resultado + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
            ...
            if (url.Contains("test"))
            {
                ...
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://test-positiva.adacsc.co/AdmoEPP/MatrizEPPPDF?id=" + resultado + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
            ...
            if (url.Contains("adacsc"))
            {
                ...
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://positiva.adacsc.co/AdmoEPP/MatrizEPPPDF?id=" + resultado + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
        ...
        public ActionResult AsignacionPDF(string id)
        {
            ...
            if (url.Contains("localhost"))
            {
                ...
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://localhost:3163/AdmoEPP/AsignacionEPPPDF?id=" + id.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
            ...
            if (url.Contains("test"))
            {
                ...
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://test-positiva.adacsc.co/AdmoEPP/AsignacionEPPPDF?id=" + id.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
            ...
            if (url.Contains("adacsc"))
            {
                ...
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://positiva.adacsc.co/AdmoEPP/AsignacionEPPPDF?id=" + id.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
        ...
        public ActionResult EPP_PDF(string id)
        {
            ...
            if (url.Contains("localhost"))
            {
                ...
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://localhost:3163/AdmoEPP/EPPPDF?id=" + Id_EPP.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
                return new Rotativa.UrlAsPdf(ReporteUrl)
                {
                    FileName = "Alissta_EPP" + DateTime.Now.ToString().Replace("/", "").Replace(":", "").Replace(" ", "").Replace(".", "") + ".pdf"
                                                    ,
            ...
            if (url.Contains("test"))
            {
                ...
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://test-positiva.adacsc.co/AdmoEPP/EPPPDF?id=" + Id_EPP.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
                return new Rotativa.UrlAsPdf(ReporteUrl)
                {
                    FileName = "Alissta_EPP" + DateTime.Now.ToString().Replace("/", "").Replace(":", "").Replace(" ", "").Replace(".", "") + ".pdf"
                                                    ,
            ...
            if (url.Contains("adacsc"))
            {
                ...
                string cusomtSwitches = string.Format("--footer-line --print-media-type --allow {0} --footer-html {0} --header-line --print-media-type --allow {1} --header-html {1} --header-spacing 5",
                footurl, headerurl);
                var ReporteUrl = "http://positiva.adacsc.co/AdmoEPP/EPPPDF?id=" + Id_EPP.ToString() + "&NitEmpresa=" + EncodedNit + "&IdEmpresa=" + usuarioActual.IdEmpresa.ToString();
                return new Rotativa.UrlAsPdf(ReporteUrl)
                {
                    FileName = "Alissta_EPP" + DateTime.Now.ToString().Replace("/", "").Replace(":", "").Replace(" ", "").Replace(".", "") + ".pdf"
                                                    ,
