...
namespace SG_SST.Services.LiderazgoGerencial.Services
{
    ...
    public class PresupuestoServicios : IPresupuestoServicios
    {
        ...
        {
            return presupuestoRepositorio.GuardarPresupuesto(actividadesPresupuesto, edInfoauditoria);
        }
        ...
        {
            return presupuestoRepositorio.EliminarPresupuesto(actividadesPresupuesto, PK_Presupuesto, edInfoauditoria);
        }
        ...
        {
            return presupuestoRepositorio.EliminarActividad(pkActividad, edInfoauditoria);
        }
    }
}