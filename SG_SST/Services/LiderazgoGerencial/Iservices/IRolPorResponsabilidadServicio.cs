...
namespace SG_SST.Services.LiderazgoGerencial.Iservices
{
    ...
    interface IRolPorResponsabilidadServicio
    {
        ...
        bool GuardarRolYResponsabilidades(Rol rol, List<Responsabilidades> responsabilidad, List<RendicionDeCuentas> rendicion, int Pk_Id_Empresa, EDInformacionAuditoria edInfoauditoria);
        ...
        bool EditarRolYResponsabilidades(Rol rol, List<Responsabilidades> responsabilidad, List<RendicionDeCuentas> rendicionDeCuenta, int[] responsaEliminadas, int[] rendiciEliminadas, int Pk_Id_Empresa, EDInformacionAuditoria edInfoauditoria);
        ...
        bool EliminarRolYResponsabilidades(int id, EDInformacionAuditoria edInfoauditoria);
