...
namespace SG_SST.Repositories.Planificacion.IRepositories
{
    ...
    interface IPeligroRepositorio
    {
        ...
        bool GuardarPeligro(Peligro peligro,EDInformacionAuditoria edInfoAuditoria);
        ...
        bool EliminarPeligros(int IdSede, int IdMetodologia,EDInformacionAuditoria edInfoAuditoria);
        ...
        bool EliminarPeligro(int Pk_Peligro,EDInformacionAuditoria edInfoAuditoria);
    }
}
