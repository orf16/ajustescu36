...
namespace SG_SST.Repositories.Planificacion.Repositories
{
   ...
   // using SG_SST.Utilidades.Traza;
    ...
    public class PeligroRepositorio : IPeligroRepositorio
    {
                    ...
                    List<PeligrosPorSede> peligrosSede =
                               peligrosDeSedes.Select(peligro =>
                                   new PeligrosPorSede(peligro.FK_Sede,
                                                       ...
                                                       peligro.ConsecuenciasPorPeligros.FirstOrDefault().Consecuencia.Grupo.Metodologia.Descripcion_Metodologia,
                                                       peligro.Fecha_De_Evaluacion)).ToList();
        ...
        public bool EliminarPeligros(int IdSede, int IdMetodologia,EDInformacionAuditoria edInfoAuditoria)
        {
            using (var transaction = db.Database.BeginTransaction())
            {
                try
