...
namespace SG_SST.Repositories.Politica.IRepositories
{
    ...
    interface IPoliticaRepositorio
    {
        ...
        bool ModficarPolitica(mPolitica politica, EDInformacionAuditoria edInfoauditoria);
        ...
        bool EliminaPolitica(int ID_Empresa, EDInformacionAuditoria edInfoauditoria);
        /// <summary>
