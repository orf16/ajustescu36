...
namespace SG_SST.Repositories.LiderazgoGerencial.IRepositories
{
    ...
    interface IPresupuestoRepositorio
    {
        ...
        bool GuardarPresupuesto(List<ActividadPresupuesto> actividadesPresupuesto, EDInformacionAuditoria edInfoauditoria);
        ...
        bool EliminarPresupuesto(List<ActividadPresupuesto> actividadesPresupuesto, int PK_Presupuesto, EDInformacionAuditoria edInfoauditoria);
        ...
        bool EliminarActividad(int pkActividad, EDInformacionAuditoria edInfoauditoria);
