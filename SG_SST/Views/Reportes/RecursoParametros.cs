...
namespace SG_SST.Reportes
{
    public  class RecursoParametros
    {
        ...
        private static string grupoTexto = "";
        public static string GrupoTexto
        {
            get { return grupoTexto; }
            set { grupoTexto = value; }
        }


        private static string cargoTexto = "";
        public static string CargoTexto
        {
            get { return cargoTexto; }
            set { cargoTexto = value; }
        }
        ...
        private static string tipoComTexto;

        public static string TipoComTexto
        {
            get { return tipoComTexto; }
            set { tipoComTexto = value; }
        }

        private static int metodologia;

        public static int Metodologia
        {
        ...
        private static int tipoPeligro;

        public static int TipoPeligro
        {
            get { return tipoPeligro; }
            set { tipoPeligro = value; }
        }

        private static string metodologiaTexto;

        public static string MetodologiaTexto
        {
            get { return metodologiaTexto; }
            set { metodologiaTexto = value; }
        }


        private static string zonaLugarTexto;
        public static string ZonaLugarTexto
        {
            get { return zonaLugarTexto; }
            set { zonaLugarTexto = value; }
        }

        private static string actividadTexto;
        public static string ActividadTexto
        {
            get { return actividadTexto; }
            set { actividadTexto = value; }
        }

        private static string tipoPeligroTexto;
        public static string TipoPeligroTexto
        {
            get { return tipoPeligroTexto; }
            set { tipoPeligroTexto = value; }
        }

        private static int procesoInt;
        public static int ProcesoInt
        {
            get { return procesoInt; }
            set { procesoInt = value; }
        }

        private static string moduloTexto = "";
        public static string ModuloTexto
        {
            get { return moduloTexto; }
            set { moduloTexto = value; }
        }
        ...
        private static string encuestaTexto;

        public static string EncuestaTexto
        {
            get { return encuestaTexto; }
            set { encuestaTexto = value; }
        }
        
        
        private static string totalTrabajadores = "";

        public static string TotalTrabajadores
        {
            get { return totalTrabajadores; }
            set { totalTrabajadores = value; }
        }
   }
}